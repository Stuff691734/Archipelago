...
public class ArchipelagoCommands {
    ...
    public static int disconnectCommand(CommandContext<CommandSourceStack> context) {
        Archipelago.client.disconnect();
        return 0;
    }

    public static int addCommand(CommandContext<CommandSourceStack> context) {
    ...
    public static int generateCommand(CommandContext<CommandSourceStack> context, boolean singleLine, boolean removePermaHidden) {
    ...
    public static int connectCommand(CommandContext<CommandSourceStack> context) {
    ...
    public static int passwordCommand(CommandContext<CommandSourceStack> context, String password) {
        return Archipelago.client.setPasswordCommand(new ContextImpl(context), password);
    }

    public static int openBookCommand(CommandContext<CommandSourceStack> context, String quest_id) throws CommandSyntaxException {
    ...
    public static int getCommand(CommandContext<CommandSourceStack> context) {
        return Archipelago.client.getCommand(new ContextImpl(context));
    }

    public static int getSpecificCommand(CommandContext<CommandSourceStack> context) {
